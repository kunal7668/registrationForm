 ...
 * @author kunal
 */
public class FirstTagHandler extends BodyTagSupport {
...
//      int num = Integer.parseInt(number);
        try {
            ...
            for(int i=1; i<=10;i++){
                out.println("<h1>"+i*Integer.parseInt(number)+"</h1>");
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in FirstTagHandler tag", ex);
    }
